...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    ...
    <script type="text/javascript">
        ...
        function updateRow(id, description, currencyCode, isCashPayment, isAssociateTheClient, isVisibleAtPOS, isPending, round, keepTheChange, bankCommission, isDisableOverPayment, isOpenCashDrawer, isLinkSoftwareForHotel, isApplicableWithOtherPaymentType, associatedDLL) {
            if (!window.isDelete) {
                //alert(id);
                //$("#deptName").val(id);
                window.IU = 'U';
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab2">
                ...
                <table>
                    ...
                    <tr>
                        <td><label>Associate The Client</label></td>
                    ...
                    <tr>
                        ...
                        <td>
                            <table style="margin: 14px 0; width: 100%;">
                                <tr>
                                    <td valign="top">
                                        <input type="radio" name="keepTheChange" value="1" style="width: auto; margin-right: 4px; margin-top: -4px;"><span>Tip</span>
                                    </td>

                                    <td valign="top">
                                        <input type="radio" name="keepTheChange" value="2" style="width: auto; margin-right: 4px; margin-top: -4px;"><span>Change</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
